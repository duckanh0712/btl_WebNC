            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <asp:LinkButton ID="update" runat="server" CommandName="update" OnClick="update_Click" Text="Sửa"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="delete" runat="server" CommandName="delete" Text="Xóa"  CommandArgument='<%# Eval("ID") %>' OnClientClick="javaScript:return confirm('Bạn có chắc muốn xóa không?');"></asp:LinkButton>
